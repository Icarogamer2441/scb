...
set EXAMPLES= vars hello funcs labels char structs structs2 enums stringbuff pointer pointer2 arrays shifts get_value stack struct_bytes files startsends files2 stackvars
